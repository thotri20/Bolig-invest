...
export default function HomeView({ data }: { data: Home }) {
  return (
    <div>
      ...
      <div
        id="home"
        className="ml-[145px] mt-[150px] font font-extrabold text-5xl font-['Inter']"
      >
        <p>
      ...
      <div>
        <h1
          id="about"
          className="ml-[145px] font font-extrabold text-5xl font-['Inter'] mt-[200px]"
        >
          Om Oss
        </h1>
        <div>
      ...
      <iframe
        ...
        height="315"
        className="ml-[140px] "
        src="https://www.youtube.com/embed/8xHNvnZDi7g?si=AKLu26NQgUeV7u_D"
